...
<head>
    ...
    <title>Wilayah Rekomendasi</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">Wilayah Rekomendasi</li>
                        </ol>
                    </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <tbody>
                                    <?php foreach ($wilayahItems as $index => $wilayahItem) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="hasil_perhitungan.php?id=<?php echo $wilayahItem['id'] ?>" class="btn btn-primary btn-sm">
