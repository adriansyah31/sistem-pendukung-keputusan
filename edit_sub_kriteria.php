...
<head>
    ...
    <title>Halaman Data Sub Kriteria</title>
                    ...
                    <!-- Add icons to the links using the .nav-icon class
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="sub_kriteria.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="sub_kriteria.php">Data Sub Kriteria</a></li>
                            <li class="breadcrumb-item active">Ubah Sub Kriteria</li>
                        </ol>
                    </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="edit_sub_kriteria_proses.php" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Bobot</label>
                                    <input type="number" name="bobot" class="form-control" placeholder="Bobot" min="0" max="5" value="<?php echo $item['bobot'] ?>" required>
                                </div>
